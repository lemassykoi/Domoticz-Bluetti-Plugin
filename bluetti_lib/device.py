# Ported from bluetti_mqtt/core/devices/ac500.py
...
class AC500(BluettiDevice):
    def __init__(self, address: str, sn: str = ""):
        ...
        self.struct.add_uint_field('pack_num_configured', 3006)
        self.struct.add_bool_field('ac_output_on_command', 3007)
        self.struct.add_bool_field('dc_output_on_command', 3008)
